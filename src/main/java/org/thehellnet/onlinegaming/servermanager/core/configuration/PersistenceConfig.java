...
@Configuration
@EnableJpaRepositories(basePackages = "org.thehellnet.onlinegaming.servermanager.core.repository")
...
public class PersistenceConfig {
    ...
    public DataSource getDataSource() {
        ...
        dataSource.setJdbcUrl("jdbc:postgresql://127.0.0.1:5432/thnolg");
        dataSource.setUser("thnolg");
        dataSource.setPassword("thnolg");
    ...
    public LocalContainerEntityManagerFactoryBean getLocalContainerEntityManagerFactoryBean() {
        ...
        entityManagerFactory.setPackagesToScan("org.thehellnet.onlinegaming.servermanager.core.model.persistence");
