...
def logDir = PathUtility.join(System.getProperty("user.home"), "log", "thehellnet")
def logName = "servermanager-core"
...
logger("org.thehellnet.onlinegaming.servermanager", DEBUG, ["FILE_GENERIC"])
